...
<<<<<<< Updated upstream
        if not target or not time:
            raise MissingRequiredArgument("Цель и/или время")
=======
        if not target:
...
<<<<<<< Updated upstream
        if not target or not mute_type:
            raise MissingRequiredArgument("Цель и/или тип мута")
=======
        if not target:
            raise MissingRequiredArgument(target)
...
<<<<<<< Updated upstream
        if not target or not unmute_type:
            raise MissingRequiredArgument("Цель и/или тип мута")
=======
        if not target:
            raise MissingRequiredArgument(target)
...
>>>>>>> Stashed changes
    ...
    async def clear(self, ctx, amount: int):
        ...
        if not amount:
<<<<<<< Updated upstream
            raise MissingRequiredArgument("Количество сообщений")
=======
...
<<<<<<< Updated upstream
        if not target or not role or not time:
            raise MissingRequiredArgument("Цель и/или время и/или роль")
=======
        if not target:
            raise MissingRequiredArgument(target)
        if not role:
...
>>>>>>> Stashed changes
    ...
    async def echo(self, ctx: Context, *, phrase: str):
        if not phrase:
<<<<<<< Updated upstream
            raise MissingRequiredArgument("фраза")
=======
